        ...
        <div style={{ padding: isMobile ? "50px 20px 60px" : "80px 40px" }}>
            <div style={{ maxWidth: 1280, margin: "0 auto" }}>
                ...
                <div style={{ marginBottom: isMobile ? 48 : 72 }}>
                    <div style={{ fontFamily: "", fontSize: ".6rem", letterSpacing: ".38em", color: "#C8A84B", textTransform: "uppercase", marginBottom: 14 }}>Our Story</div>
                    <h1 style={{ color: "#4A7A72", fontSize: isMobile ? "clamp(2rem,8vw,2.6rem)" : "clamp(2.5rem,5vw,4.2rem)", fontWeight: 300, letterSpacing: "-.02em", lineHeight: 1.1 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? 32 : 80, marginBottom: isMobile ? 56 : 90 }}>
                    <div>
                        ...
                        <p style={{ color: "#f8faf9", lineHeight: 1.9, fontSize: ".93rem", marginBottom: 16 }}>
                        ...
                        <p style={{ color: "#f8faf9", lineHeight: 1.9, fontSize: ".93rem" }}>
