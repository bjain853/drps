        ...
        <div>
            ...
            <section style={{ minHeight: "88vh", display: "flex", alignItems: "center", padding: isMobile ? "60px 20px 50px" : "80px 40px", position: "relative", overflow: "hidden" }}>
                ...
                <div style={{ maxWidth: 1280, margin: "0 auto", zIndex: 2, position: "relative", width: "100%" }}>
                    <h1 className="f2" style={{ fontSize: isMobile ? "clamp(2.2rem,9vw,3rem)" : "clamp(2.6rem,6.5vw,5.8rem)", fontWeight: 300, lineHeight: 1.08, letterSpacing: "-.02em", marginBottom: 22, maxWidth: 800 }}>
                        India's Trusted Name<br />in <em style={{ fontStyle: "italic", color: "#C8A84B" }}>Non-Ferrous Metals</em>
                    </h1>
                    <p className="f3" style={{ color: "#85c6bb", fontSize: isMobile ? "0.95rem" : "1.05rem", lineHeight: 1.85, maxWidth: 520, marginBottom: 16 }}>
                    ...
                    <div className="f3" style={{ display: "inline-flex", alignItems: "center", gap: 12, border: "1px solid #1D5048", padding: "9px 16px", marginBottom: 36, flexWrap: "wrap" }}>
                        <span style={{ fontFamily: "'Rajdhani',sans-serif", fontSize: ".70rem", fontWeight: '600', letterSpacing: ".2em", color: "#e8c55b", textTransform: "uppercase" }}>70+ Years of Unbroken Trading Heritage</span>
                    </div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr 1fr" : "repeat(3,1fr)", gap: isMobile ? "28px 16px" : "0" }}>
                        {[
                            ...
                            <div key={i} style={{ textAlign: "center", padding: isMobile ? "0" : "20px 0", borderRight: !isMobile && i < 3 ? "1px solid #154038" : "none" }}>
                                <div style={{ fontFamily: "'Rajdhani',sans-serif", fontSize: isMobile ? "1.9rem" : "2.4rem", fontWeight: 700, color: "#C8A84B", letterSpacing: ".05em" }}>{s.num}</div>
                                <div style={{ fontSize: ".62rem", letterSpacing: ".16em", color: "#f8fdfc", textTransform: "uppercase", fontFamily: "'Rajdhani',sans-serif", marginTop: 4 }}>{s.label}</div>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            < section style={{ padding: isMobile ? "50px 20px" : "90px 40px" }}>
                <div style={{ maxWidth: 1280, margin: "0 auto" }}>
                    <div style={{ marginBottom: 40 }}>
                        <div style={{ fontFamily: "'Rajdhani',sans-serif", fontSize: ".6rem", letterSpacing: ".38em", color: "#C8A84B", textTransform: "uppercase", marginBottom: 12 }}>What We Trade</div>
                        <h2 style={{ fontSize: isMobile ? "1.9rem" : "clamp(2rem,4vw,3rem)", fontWeight: 300, letterSpacing: "-.02em" }}>Our Metal Portfolio</h2>
                    </div>
                    <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr 1fr" : "repeat(auto-fill,minmax(185px,1fr))", gap: 2 }}>
                        {METALS.map(m => (
                            <Link style={{ textDecoration: 'none' }} key={m.id} href="/products">
                                <div className="card" style={{ padding: isMobile ? "20px 16px" : "26px 22px" }}>
                                    <div style={{ fontFamily: "'Rajdhani',sans-serif", fontWeight: 700, fontSize: ".6rem", letterSpacing: ".28em", color: "#C8A84B", marginBottom: 8 }}>{m.symbol}</div>
            ...
            < section style={{ padding: isMobile ? "50px 20px" : "90px 40px", background: "linear-gradient(135deg,#082220,#0C2E2A)" }}>
                <div style={{ maxWidth: 860, margin: "0 auto", textAlign: "center" }}>
                    ...
                    <div style={{ fontFamily: "'Rajdhani',sans-serif", fontSize: ".6rem", letterSpacing: ".38em", color: "#8B6914", textTransform: "uppercase", marginBottom: 16 }}>Our Heritage</div>
                    <h2 style={{ fontSize: isMobile ? "1.7rem" : "clamp(1.8rem,3.5vw,2.7rem)", fontWeight: 300, letterSpacing: "-.02em", marginBottom: 20 }}>
                        From Sadar Bazar to<br /><em style={{ color: "#C8A84B" }}>the World</em>
                    </h2>
                    <p style={{ color: "#78c1b5", fontSize: isMobile ? "0.88rem" : "1rem", lineHeight: 1.9, maxWidth: 660, margin: "0 auto 16px" }}>
                    ...
                    <p style={{ color: "#4cc6b3", fontSize: isMobile ? "0.82rem" : "0.9rem", lineHeight: 1.9, maxWidth: 620, margin: "0 auto", marginBottom: 36 }}>
