...
export default function ProductClient({ searchedMetal }) {
    ...
    if (searchedMetal != null) {
        ...
        return (
            <div className="" style={{ padding: isMobile ? "50px 20px 60px" : "80px 40px" }}>
                <div style={{ maxWidth: 1280, margin: "0 auto" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(auto-fill,minmax(300px,1fr))", gap: 8, zIndex: 10 }}>
                        {METALS.map(m => (
                            <Link key={m.id} href={`/products?metal=${m.id}`}>
                                <div className="card" style={{ padding: isMobile ? "24px 20px" : "34px 30px" }} >
